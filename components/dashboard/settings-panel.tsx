  ...
  return (
    ...
    >
      <div className="space-y-8 mb-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              ...
              {isLight && <Check className="w-4 h-4 ml-auto text-primary" />}
            </button>
            ...
            >
              ...
              {isDark && <Check className="w-4 h-4 ml-auto text-primary" />}
            </button>
          </div>
        </div>
        ...
        <div className="p-4 bg-accent/50 rounded-2xl border border-dashed border-muted-foreground/20 mt-8">
